  ...
  return (
    <>
      ...
      <div className="content">
        <div className="text">
          잘 알려지지 않은 철새 중에서 ‘개리’ 라고 하는 철새가 있습니다. ‘개리’라 는 이름은 요즘 활동하는 어느 힙합가 수와 동일하기도 하고 새의 이름이라 고
          보기에는 좀 독특하다고 할 수 있 습니다. 이름의 유래는 주로 갯벌에 서 먹이를 잡고 생활하기 때문에 갯 기러기로 불리다가 개리가 되었다고 알려져 있는데
          이름 외에도 알면 알수록 여러 가지로 신기한 새입니다.
          <br />
          <br />
          겨울철에만 우리나라에서 머물다가 떠나는 개리는 주로 러시아의 극동 이나 중국의 동북부에서 번식을 합니다. 그런데 지난 30년 동안 중국 내 의 개리 번식지가
          파괴되거나 농지로 개발되면서 번식수가 90%정도 감 소한 것으로 알려졌습니다. 우리나라에서도 흔하게 볼 수 있는 겨울철 새였지만 지금은 주로 임진강하구와
          한강하구의 지역에서만 발견되고 있습니다. 이제 전 세계에 남은 개리의 수는 약 60,000~90,000마리 정도 입니다. 철새인 개리는 한 국가에서만 보호하는
          것으로는 지킬 수가 없 습니다. 여러 나라가 힘을 모아서 개리의 힘찬 날갯짓을 지킬 수 있도록 노력하는 것이 필요합니다.
        </div>
      </div>
